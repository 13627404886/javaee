...
public class ProductDao {
    ...
    @Autowired
    public ProductDao(ProductPoMapper productPoMapper, OnSaleDao onSaleDao, ProductAllMapper productAllMapper, ProductAllMapper_link productAllMapperLink) {
        this.productPoMapper = productPoMapper;
        this.onSaleDao = onSaleDao;
        this.productAllMapper = productAllMapper;
        this.productAllMapper_link = productAllMapperLink;
    }
    ...
    public List<Product> findProductByName_link(String name) throws BusinessException{
        ...
        criteria.andNameEqualTo(name);
        List<ProductAllPo> productPoList = productAllMapper_link.getProductByName_link(name);
        productList =  productPoList.stream().map(o->CloneFactory.copy(new Product(), o)).collect(Collectors.toList());
        logger.debug("findProductByName_link: productList = {}", productList);
        return productList;
    }
}
